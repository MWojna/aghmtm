...
MAX_INTERPOLATION_GAP = 2    # Maksymalna luka do interpolacji (w komórkach)
...
df = pd.read_excel('Fizyka.xlsx', sheet_name='Arkusz1', header=None)
...
plt.title('Rozkład pola elektrycznego w kondensatorze płaskim', pad=15)
